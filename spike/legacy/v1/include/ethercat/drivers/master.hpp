...
#ifndef __ETHERCAT_DRIVERS_MASTER_H__
#define __ETHERCAT_DRIVERS_MASTER_H__
...
private: /* --------------------------------------------------- Private data ------------------------------------------------------ */
    ...
    abstract::pdo::ImageBuffer input_pdi;
    /// Output Process Data Image buffer
    abstract::pdo::ImageBuffer output_pdi;
...
#include "ethercat/drivers/master/pdo_entry_registration_proxy.hpp"
#include "ethercat/drivers/master/master_priv.hpp"
#include "ethercat/drivers/master/master_prot.hpp"
#include "ethercat/drivers/master/master_pub.hpp"
