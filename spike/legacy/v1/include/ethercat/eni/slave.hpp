...
public: /* ----------------------------------------------------- Public types ----------------------------------------------------- */
    ...
    struct PdosSet {
        ...
        /// Input variables
        std::vector<Pdo> inputs;
        /// Output variables
        std::vector<Pdo> outputs;
...
public: /* ---------------------------------------------------- Public methods ---------------------------------------------------- */
     ...
     */
    std::vector<Pdo> get_pdos(Pdo::Direction direction) const;
     ...
     *    SM (SyncManager)
     */
    std::vector<Pdo> get_assigned_pdos(Pdo::Direction direction) const;
