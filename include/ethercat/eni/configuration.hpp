...
public: /* --------------------------------------------------- Public methods ----------------------------------------------------- */
    ...
    /**
     * @returns empty
     *    optional if all slaves have unique names, auto-increment and physical adresses
     * @returns slave 
     *    description of the first non-unique slave
     */
    std::optional<Slave> are_slaves_unique() const;
