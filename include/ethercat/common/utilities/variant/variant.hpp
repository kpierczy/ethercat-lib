...
namespace std {
    ...
    template<template<typename> typename HandlerTemplate, ::ethercat::common::utilities::details::VisitorType type, typename... _Args>
    struct variant_size<::ethercat::common::utilities::details::VisitorWrapper<HandlerTemplate, variant<_Args...>, type>> : 
        public variant_size<::ethercat::common::utilities::VariantDispatch<HandlerTemplate, variant<_Args...>>> {};

    /// Specialization of @ref variant_alternative for visitor variant wrapper
    template<template<typename> typename HandlerTemplate, ::ethercat::common::utilities::details::VisitorType type, size_t _Np, typename... _Args>
    struct variant_alternative<_Np, ::ethercat::common::utilities::details::VisitorWrapper<HandlerTemplate, variant<_Args...>, type>> : 
        public variant_alternative<_Np, ::ethercat::common::utilities::VariantDispatch<HandlerTemplate, variant<_Args...>>> {};
