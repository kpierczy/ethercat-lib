...
#ifndef __ETHERCAT_COMMON_SYNCHRONISATION_LOCKS_H__
#define __ETHERCAT_COMMON_SYNCHRONISATION_LOCKS_H__
...
#include "ethercat/common/synchronisation/locks/locks.hpp"
